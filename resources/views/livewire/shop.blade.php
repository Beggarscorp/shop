            ...
            @foreach ($products as $product)
                ...
                <div class="text-gray-500 space-y-3">
                    ...
                    <div class="flex flex-wrap justify-between">
                        <div class="text-yellow-600 text-xl text-center">{{ $product->productname }}</div>
                    ...
                    <div>
                        <button class="w-full bg-yellow-600 text-white flex justify-center items-center rounded py-1">
                            Add to Cart 
