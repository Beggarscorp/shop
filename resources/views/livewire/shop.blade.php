            ...
            @foreach ($products as $product)
                ...
                <div class="text-gray-500 space-y-5">
                    ...
                    <div class="flex flex-wrap justify-between">
                        <div class="text-yellow-600 text-md text-center font-semibold">{{ $product->productname }}</div>
                        <div class="flex items-center font-semibold"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="oklch(55.1% 0.027 264.364)" d="M17 6V4H6v2h3.5c1.302 0 2.401.838 2.815 2H6v2h6.315A2.994 2.994 0 0 1 9.5 12H6v2.414L11.586 20h2.828l-6-6H9.5a5.007 5.007 0 0 0 4.898-4H17V8h-2.602a4.933 4.933 0 0 0-.924-2H17z"></path></svg>
                            @if (!empty($product->sale_price) && (int)$product->sale_price !== 0)
                            <span class="line-through text-red-500 pr-2">{{ $product->price }}</span>                                
                    ...
                    <div>
                        <button wire:click="addtocart({{ $product->id }})" class="cursor-pointer w-full bg-yellow-600 text-white flex justify-center items-center rounded py-1 font-semibold">
                            Add to Cart 
