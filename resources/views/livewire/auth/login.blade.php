    ...
    <form wire:submit.prevent="login" class="space-y-5">
      ...
      <div>
        ...
        <input type="email" id="email" wire:model="email" placeholder="example@email.com"
               class="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
      ...
      <div>
        <button type="submit"
                class="w-full bg-blue-500 text-white font-medium py-3 rounded-lg hover:bg-blue-600 transition duration-300">
          Login
        </button>
      </div>
    </form>
